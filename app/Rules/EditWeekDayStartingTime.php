...
class EditWeekDayStartingTime implements Rule
{
    private $doctor, $weekDay, $sessionId, $a;

    /**
     * Create a new rule for checking if time session overlaps with other if current time changed in editing session.
     *
     ...
     * @param $sessionId
     */
    public function __construct($doctor, $weekDay, $sessionId)
    {
        $this->doctor = $doctor;
