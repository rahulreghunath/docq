...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(52)("16a39c6f", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mixins_helper__ = __webpack_require__(974);
//
//
//
//
    ...
    methods: {
        ...
        getFormDetails: function getFormDetails() {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_1__http_http__["a" /* default */])({
                ...
                _this2.qualifications = data.data.qualifications;
            });
        }
    },
                              ...
                              _c(
                                "b-form-group",
                                {
                                  attrs: {
                                    ...
                                    state: _vm.form.has("specialisations")
                                  }
                                },
                                [
                                  _c("b-form-select", {
                                    ...
                                    model: {
                                      value: _vm.form.specialisations,
                                      callback: function($$v) {
                                        _vm.$set(
                                          _vm.form,
                                          "specialisations",
                                      ...
                                      expression: "form.specialisations"
                                    }
                                  })
                                ],
                                1
                              ...
                              _c(
                                "b-form-group",
                                {
                                  attrs: {
                                    ...
                                    state: _vm.form.has("qualifications")
                                  }
                                },
                                [
                                  _c("b-form-select", {
                                    ...
                                    model: {
                                      ...
                                      expression: "form.qualifications"
                                    }
                                  })
                                ],
                                1
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(52)("c12dd84e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_helper__ = __webpack_require__(974);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__http_http__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_cropperjs__ = __webpack_require__(1627);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_cropperjs_dist_cropper_css__ = __webpack_require__(1628);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_alert__ = __webpack_require__(1445);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__constants_constants__ = __webpack_require__(142);
//
//
//
//
    ...
    methods: {
            ...
            if (this.image === null) {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_4__shared_alert__["a" /* default */])({
                    ...
                    Object(__WEBPACK_IMPORTED_MODULE_1__http_http__["a" /* default */])({ type: 'post', url: 'add-doctor-profile-image', data: form }).then(function (_ref) {
                        ...
                        if (data.status === __WEBPACK_IMPORTED_MODULE_5__constants_constants__["e" /* SUCCESS_STATUS */]) {
        ...
        getDoctorDetails: function getDoctorDetails() {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_1__http_http__["a" /* default */])({ type: 'get', url: 'get-doctor-basic-details-img', data: { doctor: this.id } }).then(function (_ref2) {
                ...
                _this2.$router.push({ name: 'addDoctor' });
            });
        },
                  ...
                  _c(
                    ...
                    [
                      _c("b-col", { attrs: { sm: "12" } }, [
                        _c("h4", [
                          _vm._v(" Dr. " + _vm._s(_vm.doctor.full_name))
                        ])
                      ]),
                      _vm._v(" "),
                      _c("b-col", { attrs: { sm: "12" } }, [
