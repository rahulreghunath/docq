...
// exports
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        Object.defineProperty(__webpack_exports__, "__esModule", {value: true});
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_0__shared_form__ = __webpack_require__(159);
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_1__http_http__ = __webpack_require__(86);
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_2__mixins_helper__ = __webpack_require__(1017);
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_3_vue2_google_maps__ = __webpack_require__(161);
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_3_vue2_google_maps___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_vue2_google_maps__);
//
//
//
//
            ...
            methods: {
                ...
                getLocation: function getLocation() {
                    ...
                    this.$refs.map.$mapPromise.then(function (map) {
                        ...
                        _this2.geocoder.geocode({address: _this2.form.location.length === 0 ? 'Kerala' : _this2.form.location}, function (result, status) {
                            if (status === "OK") {
                                map.panTo(result[0].geometry.location);
                                _this2.marker.setPosition(result[0].geometry.location);
                                _this2.marker.setDraggable(true);
                                _this2.marker.setIcon('Admin/marker/marker-2.png');
                                customInfowindow.setContent('Drag the marker to your location');
                                customInfowindow.open(map, _this2.marker);
                        ...
                        customInfowindow.open(map, _this2.marker);
                        _this2.marker.addListener('click', function (e) {
                            _this2.form.latitude = e.latLng.lat();
                            _this2.form.longitude = e.latLng.lng();
                            if (_this2.marker.draggable) {
                                _this2.marker.setDraggable(false);
                                _this2.marker.setIcon('Admin/marker/marker-1.png');
                            } else {
                                _this2.marker.setDraggable(true);
                                _this2.marker.setIcon('Admin/marker/marker-2.png');
                            }
                        ...
                        _this2.marker.addListener('drag', function (e) {
                            customInfowindow.close();
                        });
                        _this2.marker.addListener('dragend', function () {
