...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__constants_constants__ = __webpack_require__(87);
//
//
//
//
            ...
            if (this.image === null) {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_4__shared_alert__["a" /* default */])({
                    ...
                    Object(__WEBPACK_IMPORTED_MODULE_1__http_http__["a" /* default */])({ type: 'post', url: 'add-doctor-profile-image', data: form }).then(function (_ref) {
                        ...
                        if (data.status === __WEBPACK_IMPORTED_MODULE_5__constants_constants__["c" /* SUCCESS_STATUS */]) {
