...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-095d128e", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/Doctor/components/views/users/User.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-095d128e", Component.options)
  } else {
    hotAPI.reload("data-v-095d128e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
