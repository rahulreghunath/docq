...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4fb0c709", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/Doctor/components/views/notifications/Modals.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4fb0c709", Component.options)
  } else {
    hotAPI.reload("data-v-4fb0c709", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
