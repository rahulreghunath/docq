...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-657bf45f", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/Doctor/components/views/base/ProgressBars.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-657bf45f", Component.options)
  } else {
    hotAPI.reload("data-v-657bf45f", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
