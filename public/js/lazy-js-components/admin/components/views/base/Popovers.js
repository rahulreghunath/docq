...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-362dbe80", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/Doctor/components/views/base/Popovers.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-362dbe80", Component.options)
  } else {
    hotAPI.reload("data-v-362dbe80", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
