                        ...
                        <b-row>
                            <b-col sm="4">
                                ...
                                >
                                    ...
                                    ></b-form-select>
                                    <!--<suggestion-list :items="doctors" v-model="doctor" @change="getClinics($event)"></suggestion-list>-->
                                </b-form-group>
                            </b-col>
                            <b-col sm="4">
                                <b-form-group
                                ...
                                >
                                    ...
                                    <!--<suggestion-list :items="clinics" v-model="clinic" @change="selectClinic($event)"></suggestion-list>-->
                                </b-form-group>
                            </b-col>
                            <b-col sm="4">
                                <b-form-group
...
<script>
    ...
    import {ENTER_ALL_DETAILS} from "../../../constants/messages";
